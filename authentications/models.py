...
class FlightManager(BaseUserManager):
    ...
    def create_user(self, email_address, username=None,
    password=None,first_name=None,last_name=None, phone_number=None):
        """Creation of user"""
        ...
        return user
    def create_admin(self,email_address,password,username =None):
