...
from authentications.views import (UserLogin, UserDetails,
                                   ...
                                   ChangePassword,RequestResetPasswordEmail,
...
urlpatterns = [
    ...
    path("reset-password/confirm/",ResetPasswordLinkVerify.as_view(), name="reset-password-confirm"),
    path("reset-password/done/",ResetPasswordView.as_view(), name="reset-password-done"),
